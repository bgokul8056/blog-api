...
SECRET_KEY = os.environ.get('SECRET_KEY', default='QG8Z5oT9D8oU32Memac8Z4BEH1MdbqlH9QsXPXxrtx8')

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = env.bool('DEBUG', default=False)
DEBUG = 'RENDER' not in os.environ

ALLOWED_HOSTS = ["https://gokul-test.onrender.com","localhost", "127.0.0.1"]
...
#     }
# }
# Django for beginners recommendation
# DATABASES = {
